...
import com.example.swaggerclient.auth.ApiKeyAuth;
import com.example.swaggerclient.auth.HttpBasicAuth;
import com.example.swaggerclient.auth.OAuth;
...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "https://virtserver.swaggerhub.com/oottru/sample/1.0.0";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
